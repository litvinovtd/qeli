...
<style>
.main-content table{border-collapse:collapse;width:auto;margin:1.2em 0}
.main-content table th,.main-content table td{border:1px solid #c9d1d9;padding:6px 14px;text-align:left}
.main-content table thead th{background:#f3f6fb}
...
![Android-клиент: подключение, профили и журнал](habr-assets/client-android-trio.png)
