...
![Android: подключение](habr-assets/client-android-connected.png)
*Экран подключения: кольцо tap-to-connect, статус, uptime и скорости.*

![Android: профили](habr-assets/client-android-profiles.png)
*Профили — все режимы маскировки на разных портах одного сервера.*

![Android: журнал](habr-assets/client-android-log.png)
*Живой лог рукопожатия: ClientHello (1438 B, hybrid X25519+ML-KEM), проверка идентичности, Auth OK, multipath.*
