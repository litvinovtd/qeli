...
![Веб-панель администратора](habr-assets/panel-dashboard.png)
...
![Десктоп-клиент: главный экран](habr-assets/client-desktop-main.png)
...
![Десктоп-клиент: редактор профиля](habr-assets/client-desktop-editor.png)
...
![Android-клиент: подключение](habr-assets/client-android-connected.png)
