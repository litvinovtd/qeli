...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string en, string ru)> Strings = new()
    {
        ...
        ["FieldApps"] = ("Separate application tunneling", "Раздельное туннелирование приложений"),
        ["AppsAll"] = ("All apps via VPN", "Все приложения через VPN"),
        ["AppsExclude"] = ("Selected apps bypass VPN", "Выбранные мимо VPN"),
        ["AppsInclude"] = ("Only selected apps via VPN", "Только выбранные через VPN"),
        ["AppsPick"] = ("Choose apps…", "Выбрать приложения…"),
        ["AppsPicked"] = ("{0} selected", "Выбрано: {0}"),
        ["AppsPickerTitle"] = ("Application selection", "Выбор приложений"),
        ["AppsPickerHint"] = ("Tick apps that the rule applies to (running processes). Use Browse to add an .exe that is not running.",
                              "Отметьте приложения, к которым применяется правило (запущенные процессы). «Обзор» — добавить .exe, который сейчас не запущен."),
        ["AppsBrowse"] = ("Browse…", "Обзор…"),
        ["Off"] = ("Off", "Выкл"),
        ["On"] = ("On", "Вкл"),
