...
Точечные фиксы стабильности: реконнект Rust-клиента, создание Wintun-адаптера на
Windows, и понятная ошибка share-ссылки для не-загруженного профиля. Сетево совместимо
с 0.7.4; дефолты конфига не менялись.
