...
- **Язык**: Rust 2021, версия 0.7.0 (бета)
...
туннель (гибрид X25519+ML-KEM) + аудит-фиксы 2026-06-11. PQ затрагивает только
рукопожатие (разовая стоимость), пропускная способность не изменилась, поэтому
замеры ниже актуальны ([BENCHMARK.md](BENCHMARK.md), 2 vCPU лаба, измерено на v0.5.6):
