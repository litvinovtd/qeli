...
> **Исторический снимок от 2026-06-05/06.** Весь документ, включая «актуальную сводку»,
> фиксирует состояние и результаты того периода; число клиентов, ABI, binaries, тесты и
