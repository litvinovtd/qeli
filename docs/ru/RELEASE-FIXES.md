...
> **Исторический release log.** Для актуальной миграции Reality/H2 dev 0.8.0 используйте
> [CONFIG.md](CONFIG.md), [DPI-AUDIT.md](DPI-AUDIT.md) и [CHANGELOG](../../CHANGELOG.md).

> **Статус документа:** исторический рабочий чек-лист аудита 2026-06-06 с последующими
> отметками о выполнении. Он не описывает текущую готовность ветки `0.7.16` и не должен
> использоваться как актуальное разрешение на релиз. Полный список новых исправлений находится
> в [CHANGELOG](../../CHANGELOG.md), а пользовательское и эксплуатационное описание — в
> [release notes 0.7.16](../../release/RELEASE_NOTES_0.7.16.md).
